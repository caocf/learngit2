...
#import "DesEncryptDecipher.h"
#import "CommonCrypto/CommonDigest.h"    //MD5
#import <CommonCrypto/CommonCryptor.h>  //DES 加密



@implementation DesEncryptDecipher

+ (NSString *)base64StringWithDictionary:(NSDictionary *)dictionary
{
    return [[self class] base64StringFromText:[dictionary JSONString] withKey:@"e6gisgps"];
}
