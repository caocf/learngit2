...
@interface WALChildAreaVehicleViewController () <UITableViewDataSource, UITableViewDelegate, PullTableViewDelegate>
...
@implementation WALChildAreaVehicleViewController
